    ...
    <section className="relative overflow-hidden pb-16 pt-36 sm:pb-24 sm:pt-44">
      ...
      <div className="container relative grid grid-cols-1 items-center gap-16 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-7">
          ...
          <FadeIn delay={0.1}>
            <h1 className="mt-6 text-balance text-display-xl font-semibold text-gradient">
          ...
          <FadeIn delay={0.4}>
            <div className="mt-14 flex flex-wrap items-center gap-x-8 gap-y-3 border-t border-white/[0.06] pt-8">
              <p className="text-xs uppercase tracking-widest text-gray-dim">
                Confiado por equipos de operación en
              </p>
              <div className="flex flex-wrap items-center gap-x-7 gap-y-2 text-sm font-medium text-gray-soft/70">
                <span>Salud</span>
                <span>Logística</span>
                <span>Retail</span>
